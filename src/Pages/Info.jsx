...
function Info() {
  ...
  return (
    <div className="info">
      <div className='info-div'>
        ...
        <p>Также вы можете
          отслеживать степень готовности заказов по их статусам в разделе "Мои заказы"
  ...
  <div className='place-container'>
    <div className="location-info">
      <p>г. Вологда</p>
      <p>улица Фрязиновская, дом 20</p>
    </div>

    <div className="map-container">
      <a
        href="https://yandex.ru/maps/?text=Вологда, Фрязиновская 20"
        target="_blank"
        rel="noopener noreferrer"
      >
        <img
          src="https://static-maps.yandex.ru/1.x/?lang=ru_RU&ll=39.8970,59.2180&z=16&l=map&pt=39.8970,59.2180,pm2rdl"
          alt="Карта расположения"
          className="map-image"
        />
      </a>
      ...
      <div className="map-buttons">
        ...
        <a
          href="https://www.google.com/maps/search/Вологда, Фрязиновская 20"
          target="_blank"
          rel="noopener noreferrer"
          className="map-button google"
        >
