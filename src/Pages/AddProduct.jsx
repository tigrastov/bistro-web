    ...
    try {
      if (file) {
        ...
        try {
          ...
          console.error('Ошибка при сжатии изображения:', compressError);
          setError('Ошибка при сжатии изображения. Попробуйте другой файл.');
          return;
        }

        const storageRef = ref(storage, `products/${location}/${Date.now()}_${compressedFile.name}`);
        console.log('storageRef:', storageRef.fullPath);
